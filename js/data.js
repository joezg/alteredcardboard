window.AC_SITE_DATA = {
  hero: {
    ...
    title: "Altered Cardboard builds polished tabletop experiences for the web.",
    summary:
      "A one-page showcase for Board Game Arena implementations, production work, and the studio details publishers and collaborators need at a glance.",
    stats: [
      { label: "Implementations", value: "06+" },
      { label: "Platforms", value: "BGA" },
      { label: "Focus", value: "UX + Rules" }
    ],
    bullets: [
      "Board Game Arena-first production thinking",
      "Respect for original design intent",
      "Readable interfaces and teachable flows"
    ]
  },
  about: {
